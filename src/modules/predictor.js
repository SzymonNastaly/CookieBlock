...
getExtensionFile(
  chrome.runtime.getURL("/ext_data/model/forest_class0_part1.json"),
  "json",
  (f1) => {
    getExtensionFile(
      chrome.runtime.getURL("/ext_data/model/forest_class0_part2.json"),
      "json",
      (f2) => {
...
getExtensionFile(
  chrome.runtime.getURL("/ext_data/model/forest_class1_part1.json"),
  "json",
  (f1) => {
    getExtensionFile(
      chrome.runtime.getURL("/ext_data/model/forest_class1_part2.json"),
      "json",
      (f2) => {
...
getExtensionFile(
  chrome.runtime.getURL("/ext_data/model/forest_class2_part1.json"),
  "json",
  (f1) => {
    getExtensionFile(
      chrome.runtime.getURL("/ext_data/model/forest_class2_part2.json"),
      "json",
      (f2) => {
...
getExtensionFile(
  chrome.runtime.getURL("/ext_data/model/forest_class3_part1.json"),
  "json",
  (f1) => {
    getExtensionFile(
      chrome.runtime.getURL("/ext_data/model/forest_class3_part2.json"),
      "json",
      (f2) => {
...
const getForestScore = function (forest, features) {
  ...
  return treeScores.reduce((total, nv) => {
    return total + nv;
  }, 0);
};
...
export const predictClass = async function (features, nfactor) {
  let existsUndefined = forests.reduce((total, f) => {
    return total || f === undefined;
  }, false);
  if (existsUndefined) {
  ...
  try {
    ...
    let totalScore = classScores.reduce((total, num) => {
      return total + num;
    }, 0);
    let probabilities = classScores.map((x) => {
      return x / totalScore;
    });
